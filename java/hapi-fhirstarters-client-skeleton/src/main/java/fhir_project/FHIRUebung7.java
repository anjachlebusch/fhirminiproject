...
public class FHIRUebung7 {
    public static void main(String[] args) {
      ...
      //Arzt-Rolle
       ...
       Observation immunizationTestRoeteln = createImmunizationTest(client, antonie, doctor, roetelnTest, roetelnResult);
       ...
       Observation immunizationTestCovid = createImmunizationTest(client, antonie, doctor, covidTest, covidResult);
